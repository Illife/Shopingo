...
<div class="page-wrapper">
	<div class="page-content">
		...
		<section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
			<div class="container">
				<div class="page-breadcrumb d-flex align-items-center">
					<h3 class="breadcrumb-title pe-3">Отслеживание</h3>
					<div class="ms-auto">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Отслеживание заказа</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<section class="py-4">
			<div class="container">
				<h6 class="mb-0">ID Заказа: OD45345345435</h6>
				<hr>
				<div class="row row-cols-1 row-cols-lg-4 rounded-4 gx-3 m-0 border">
					<div class="col p-4 text-center border-end">
						<h6 class="mb-1">Предполагаемое время доставки:</h6>
						<p class="mb-0">24 июля 2022</p>
					</div>
					<div class="col p-4 text-center border-end">
						<h6 class="mb-1">Доставщик:</h6>
						<p class="mb-0">BLUEDART | +91-9910XXXX</p>
					</div>
					<div class="col p-4 text-center border-end">
						<h6 class="mb-1">Статус:</h6>
						<p class="mb-0">Забрал курьер</p>
					</div>
					<div class="col p-4 text-center">
						<h6 class="mb-1">Отслеживание #:</h6>
						...
						<div class="card-body">
							<div class="steps steps-light">
								<a class="step-item active" href="javascript:;">
									...
									<div class="step-label">Заказ подтвержден</div>
								</a>
								<a class="step-item active" href="javascript:;">
									<div class="step-progress"><span class="step-count"><i class='bx bx-user-circle'></i></span>
									</div>
									<div class="step-label">Забран курьером</div>
								</a>
								...
								<a class="step-item" href="javascript:;">
									...
									<div class="step-label">Готов к самовывозу</div>
								</a>
							</div>
						</div>
					</div>
